...
import { IncrementalQuinTree, AccQueue, calcDepthFromNumLeaves, hash2, hash5 } from "../../maci-ts/crypto";
import { IVkContractParams, VerifyingKey } from "../../maci-ts/domainobjs";

import type { EthereumProvider } from "hardhat/types";

import { getDefaultSigner } from "../../maci-ts/ts";
import {
...
} from "../../maci-ts/ts/deploy";
import { IDeployedTestContracts } from "../../maci-ts/ts/types";
...
export const deployTestContracts = async (
  ...
  if (!gatekeeperContract) {
    gatekeeperContract = (await deployFreeForAllSignUpGatekeeper(signer, true)) as FreeForAllGatekeeper;
  }
