            ...
            <div className="mt-14 bg-slate-800 rounded-3xl flex overflow-hidden w-[90%] mobile:w-[93%] mobile:flex-col">
              ...
              <div className="flex flex-col p-5 gap-y-3 mobile:gap-y-0">
                ...
                <p className="mobile:text-sm">
                  Welcome to our privacy-focused voting platform. We prioritize your privacy and the security of your
                  vote with advanced encryption technology. Cast your vote with confidence, knowing your privacy is
                  protected.
                </p>
                <a
                  target="_blank"
